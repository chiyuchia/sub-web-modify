export const customBackend = [
  { label: "鲫鱼后端", value: "https://subapi.jiyujia.top", extended: true },
  {
    label: "SubConverter-Extended",
    value: "https://api.asailor.org",
    extended: true,
  },
  {
    label: "CM负载均衡后端【vless reality+hy1+hy2】",
    value: "https://subapi.cmliussss.net",
  },
  {
    label: "CM应急备用后端【vless reality+hy1+hy2】",
    value: "https://subapi.fxxk.dedyn.io",
  },
  {
    label: "肥羊增强型后端【vless reality+hy1+hy2】",
    value: "https://url.v1.mk",
  },
  {
    label: "肥羊备用后端【vless reality+hy1+hy2】",
    ...
    options: [
      {
        ...
        value:
          "https://raw.githubusercontent.com/chiyuchia/proxy-rule/refs/heads/master/clash_config.ini",
      },
      {
        label: "chiyuchia 规则（CDN）",
        value:
          "https://cdn.jsdmirror.com/gh/chiyuchia/proxy-rule@master/clash_config.ini",
      },
    ],
  },
  {
